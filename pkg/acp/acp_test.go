...
func TestACPServerSessionLifecycle(t *testing.T) {
	...
	t.Run("SessionNew", func(t *testing.T) {
		...
		if result.Capabilities.FS == nil {
			t.Error("Expected filesystem capabilities")
		}
...
func TestSessionRegistry(t *testing.T) {
	...
	t.Run("CreateAndGet", func(t *testing.T) {
		session, err := registry.Create("nano-123", "/tmp/test", nil, SessionCapabilities{}, FSModeLocal)
		if err != nil {
	...
	t.Run("Delete", func(t *testing.T) {
		session, _ := registry.Create("nano-456", "/tmp/test", nil, SessionCapabilities{}, FSModeLocal)
	...
	t.Run("List", func(t *testing.T) {
		...
		_, _ = registry.Create("nano-1", "/tmp/1", nil, SessionCapabilities{}, FSModeLocal)
		_, _ = registry.Create("nano-2", "/tmp/2", nil, SessionCapabilities{}, FSModeLocal)
