...
3. **Message Formatting**: Messages include sender ID, timestamp, and structured body
4. **Message Cleanup**: Messages expire based on TTL and can be cleared by the consumer

### Message Structure

See `docs/features/MAILBOX.md` for the canonical message structure.
